...
from .models import Hosts, Databases, Tables, ExternalConnectionByHostId, db_name_ignore_per_type
...
def synchosts(host_id):
    ...
    databases = external_session.execute(text('SHOW DATABASES;')).fetchall()    
    ...
    for _database in databases:
        ...
        if db_name in db_name_ignore_per_type[connections.type]:
            continue
